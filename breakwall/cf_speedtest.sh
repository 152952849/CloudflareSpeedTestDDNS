...
function pool_generate() {
	...
	echo -e  "  - {name: VPS1_美国_CF加速(${ID}), server: ${SERVER}, port: 443, type: vless, uuid: xxxxxxxxxxxxx, network: ws, tls: true, udp: false, sni: *.exem.com, client-fingerprint: chrome, ws-opts: {path: /?ed=2048, headers: {host: *.exem.com}}}"
}
